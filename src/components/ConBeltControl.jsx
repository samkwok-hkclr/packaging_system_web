                ...
                <table>
                    <tbody>
                        ...
                        {/* <tr>
                            <td>Direction:</td>
                            <td>
                                <input type="text" value={dir} onChange={(e)=>setDir(parseInt(e.target.value))}/>
                            </td>
                            <td>
                                <div className="btn" onClick={() => sendSDO(0x6082, 0, dir)}>Set</div>
                            </td>
                        </tr> */}
                        <tr>
                            <td>Stop by Ph:</td>
                        ...
                        <tr>
                            ...
                            <td colSpan={2}>
                                <div className="btn bg-red" onClick={() => sendSDO(0x6089, 0, 0)}>Emergency Stop</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
